...
const coursers = {
  ...
  personal:{
    ...
    groups: [
      ...
      {
        header: "Сплит тренировка",
        description: [
          "Тем, кто хочет тренироваться в паре",
          "Дает возможность сплочения, выявления новых совместных интересов.",
          "Занятие на двоих становится зажигательнее и увлекательнее!",
          "Персональная подобранная тренировка для двоих в воде на 45-60 мин",
          "Анализ вашей техники плавания и работы в воде с помощью видеозаписей или наблюдения в реальном времени",
        ]
      },
    ],
